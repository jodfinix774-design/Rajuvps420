...
DEFAULT_CONFIG = {
    "site_title": "RAJU PREMIUM VPS",
    "site_header": "RAJU VPS",
    ...
    "passwords": {
        "secret": hashlib.sha256("RAJUXADMIN24".encode()).hexdigest(),
...
async def api_check(message: types.Message):
    ...
    try:
        ...
        r = requests.get(url, timeout=15, headers={
            'User-Agent': 'Mozilla/5.0 (RAJU VPS Bot)'
        })
...
if __name__ == "__main__":
    ...
    print("=" * 50)
    print("RAJU PREMIUM VPS - Starting...")
    print("=" * 50)
    print(f"Port: {port}")
    print(f"Debug: {debug}")
    ...
    print("  Secret: RAJUXADMIN24 (Can change user password)")
